"""
Django settings for falling_limit_43081 project.
...
ROOT_URLCONF = 'falling_limit_43081.urls'
...
WSGI_APPLICATION = 'falling_limit_43081.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_limit_43081 API",
    "DESCRIPTION": "API documentation for falling_limit_43081 App",
    "VERSION": "v1",
}
